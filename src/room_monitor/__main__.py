...
def get_inputs() -> List[monitor_input.MonitorInput[Any]]:
    ...
    return [
        monitor_input.MonitorInput("Temperature", temperature_sensors.BME280TemperatureSensor(bme280_device)),
        monitor_input.MonitorInput("Humidity", humidity_sensors.BME280HumiditySensor(bme280_device))
    ]
